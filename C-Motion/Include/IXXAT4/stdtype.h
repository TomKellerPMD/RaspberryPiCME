...
#define NORETURN DECLSPEC_NORETURN
...
//
// Description:
//  This macro converts a c-style string constant to a wide character
//  string constant.
//
// Arguments:
...
//------------------------------------------------------------------------
#ifndef CSTR_TO_WSTR
#define CSTR_TO_WSTR_(cstr) L##cstr
#define CSTR_TO_WSTR(cstr)  CSTR_TO_WSTR_(cstr)
#endif
