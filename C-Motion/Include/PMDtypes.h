...
typedef enum {
        PMDCANFDDataBaudNone                                    = 0,
        PMDCANFDDataBaud5000000                                 = 4,
        PMDCANFDDataBaud4000000                                 = 5,
        PMDCANFDDataBaud2000000                                 = 6,
        PMDCANFDDataBaud1000000                                 = 7,
} PMDCANFDDataBaud;

// All CANFD bauds will also enable extended data length mode
typedef enum {
        PMDCANFDBaud1000_5000                                   = PMDCANBaud1000000 | PMDCANFDDataBaud5000000 << 4,
        PMDCANFDBaud1000_4000                                   = PMDCANBaud1000000 | PMDCANFDDataBaud4000000 << 4,
        PMDCANFDBaud1000_2000                                   = PMDCANBaud1000000 | PMDCANFDDataBaud2000000 << 4,
        PMDCANFDBaud1000_1000                                   = PMDCANBaud1000000 | PMDCANFDDataBaud1000000 << 4,
        PMDCANFDBaud500_1000                                    = PMDCANBaud500000  | PMDCANFDDataBaud1000000 << 4,
} PMDCANFDBaud;
...
typedef enum {
        ...
        PMDLoopPositionDeadbandLowerLimit                       = 0x108,
        PMDLoopPositionDeadbandUpperLimit                       = 0x109,
} PMDLoop;  // Juno only
...
typedef enum {
        ...
        PMDProfileParameterCounts				                = 1,
        PMDProfileParameterStartCount			                = 2,
        PMDProfileParameterSource				                = 3,
        PMDProfileParameterOutputOffset			                = 4,
        PMDProfileParameterInputOffset			                = 5,
        ...
        PMDProfileParameterFeedForwardBufferID	                = 14,
